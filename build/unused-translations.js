...
const I18N_PATH = path.resolve(PROJECT_ROOT, argMap.get('i18n') || 'i18n')
...
const IGNORE_UNUSED_KEYS = ['Incorrect code or password', 'Missing TWO-FA code', 'Missing permission']
